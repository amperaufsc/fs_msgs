...
bool fs_msgs__msg__motion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fs_msgs.msg._motion.Motion", full_classname_dest, 26) == 0);
  }
  fs_msgs__msg__Motion * ros_message = _ros_message;
  {  // header
  ...
  {  // odom
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'odom'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    nav_msgs__msg__Odometry * dest = ros_message->odom.data;
...
PyObject * fs_msgs__msg__motion__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fs_msgs.msg._motion");
