...
#include "fs_msgs/msg/detail/motion__rosidl_typesupport_fastrtps_c.h"
...
using _Motion__ros_msg_type = fs_msgs__msg__Motion;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: odom
  {
    ...
    size_t size = ros_message->odom.size;
    auto array_ptr = ros_message->odom.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: odom
  {
    ...
    if (ros_message->odom.data) {
      nav_msgs__msg__Odometry__Sequence__fini(&ros_message->odom);
    }
    if (!nav_msgs__msg__Odometry__Sequence__init(&ros_message->odom, size)) {
      fprintf(stderr, "failed to create array for field 'odom'");
      return false;
    }
    auto array_ptr = ros_message->odom.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_fs_msgs__msg__Motion(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Motion__ros_msg_type * ros_message = static_cast<const _Motion__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name odom
  {
    size_t array_size = ros_message->odom.size;
    auto array_ptr = ros_message->odom.data;
...
static uint32_t _Motion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fs_msgs__msg__Motion(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fs_msgs
size_t max_serialized_size_fs_msgs__msg__Motion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs__msg__Motion;
    is_plain =
      (
...
static size_t _Motion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fs_msgs__msg__Motion(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fs_msgs, msg, Motion)() {
