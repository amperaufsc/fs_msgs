...
#include "fs_msgs/msg/detail/motion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fs_msgs::msg::Motion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fs_msgs::msg::Motion & ros_message)
{
  // Member: header
  ...
  // Member: odom
  {
    ...
    ros_message.odom.resize(size);
    for (size_t i = 0; i < size; i++) {
      nav_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.odom[i]);
    }
  }
  ...
  // Member: odom
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.odom[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs::msg::Motion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fs_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fs_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_Motion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, msg, Motion)() {
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_Motion__handle;
}
